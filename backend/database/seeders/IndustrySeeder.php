...
class IndustrySeeder extends Seeder
{
    ...
    {
        $industries = [
            ['title' => 'کافه و رستوران', 'slug' => 'cafe-restaurant', 'icon' => 'Coffee', 'image' => '/storage/industries/cafe.jpg', 'description' => 'تولید محتوا برای کافه‌ها و رستوران‌ها', 'is_active' => true],
            ...
            ['title' => 'خودرو', 'slug' => 'automotive', 'icon' => 'Car', 'image' => '/storage/industries/auto.jpg', 'description' => 'تولید محتوا برای نمایشگاه‌های خودرو', 'is_active' => true],
            ['title' => 'ورزشی', 'slug' => 'sports', 'icon' => 'Dumbbell', 'image' => '/storage/industries/sports.jpg', 'description' => 'تولید محتوا برای باشگاه‌های ورزشی', 'is_active' => true],
